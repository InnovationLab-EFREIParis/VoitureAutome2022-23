...
class Driver(Node):
    ...
    def __init__(self):
        ...
        self.speed_params = 5
        self.steering_params = 5

        self.subscriber_lidar = self.create_subscription(LaserScan, 'LidarScanPreprocessed', self.__cmd_scan_callback, 1)
        self.subscriber_race_params = self.create_subscription(RaceParams, 'RaceParams', self.__cmd_race_params_callback, 1)
    ...
    def __cmd_race_params_callback(self, message):
        self.speed_params = message.speed
        self.steering_params = message.steering
    ...
    def map_speed(self, value):
        ...
        if(value < 0):
            ...
            #angle_value = 90 + ((angle_value - 90) * self.speed_params / 10)
            angle_value = max(angle_value, 104)
    ...
    def map_servo(self, value):
        ...
        angle_value = m * value + b
        #angle_value = 45 + ((angle_value - 45) * self.steering_params / 10)
        return int(angle_value)
