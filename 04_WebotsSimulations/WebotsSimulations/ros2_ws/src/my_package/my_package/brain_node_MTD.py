...
class BrainNode(Node):
    ...
    def __init__(self):
        ...
        ## TO parameterized
        safety_bubble_r = 0.099 * 10#0.029
        aperture_half_angle = 75
        disparity_threshold = 0.9 #0.8
        aperture_tight_front_half_angle_deg = 48 #45
    ...
    def execute_callback(self, lidar_scan):
        ...
        steeringCommand = direction * min(self.max_steering_angle, np.abs(angle_goal_rad) * 1.4)
