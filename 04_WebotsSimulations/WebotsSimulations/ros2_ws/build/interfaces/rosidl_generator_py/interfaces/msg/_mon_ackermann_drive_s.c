...
bool interfaces__msg__mon_ackermann_drive__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._mon_ackermann_drive.MonAckermannDrive", full_classname_dest, 53) == 0);
  }
  interfaces__msg__MonAckermannDrive * ros_message = _ros_message;
  {  // steering_angle
...
{
  /* NOTE(esteve): Call constructor of MonAckermannDrive */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._mon_ackermann_drive");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MonAckermannDrive");
